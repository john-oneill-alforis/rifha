...
def interview_analysis_question_1():
    ...
    responses = pd.read_sql_query("""SELECT secondary_answer_text FROM thesis_vert.polls_transcriptcapture where question_id IN (3);""", mydb) #Change this with the name of your downloaded file
    ...
    pyLDAvis.save_html(visualisation, 'LDA_Visualization_question_3.html')
