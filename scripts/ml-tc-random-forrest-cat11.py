...
def classify():
    ...
    cur.execute(
        ...
        """ SELECT text, label FROM polls_trainingcorpus JOIN polls_textlabels ON polls_trainingcorpus.textLabel_id = polls_textlabels.entryId WHERE polls_trainingcorpus.textLabel_id = 11;"""
    )
    rows = cur.fetchall()
    ...
    joblib.dump(rf_model, "random_forest_model_cat11.pkl")
